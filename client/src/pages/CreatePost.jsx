    ...
    <div className='min-h-screen bg-linear-to-b from-slate-50 to-white'>
      <div className='max-w-6xl mx-auto p-6'>
        ...
        <div className='mb-8'>
          ...
          <p className='text-slate-600'>Share your art to society</p>
        </div>
        ...
        <div className='max-w-xl bg-white p-4 sm:p-8 sm:pb-3 rounded-xl shadow-md space-y-4'>
          ...
          {/* Text area */}
          <textarea className='w-full resize-none max-h-20 mt-4 text-sm outline-none placeholder-gray-400' placeholder='What is up?' onChange={(e)=> setContent(e.target.value)} value={content}/>
          ...
          <div className='flex items-center justify-between pt-3 border-t border-gray-300'>
            ...
            <button disabled={loading} onClick={()=> toast.promise(
              ...
              {
                loading: 'Uploading...',
                success: <p>Art Published</p>,
                error: <p>Art is failed to Published</p>
              }
            )} className='texst-sm bg-linear-to-r from-orange-500 to-red-600 hover:from-orange-600 hover:to-red-700 active:scale-95 transition text-white font-medium px-8 py-2 rounded-md cursor-pointer'>
              Publish Art
            </button>
          </div>
        </div>
