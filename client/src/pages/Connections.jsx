    ...
    <div className='min-h-screen bg-slate-50'>
      <div className='max-w-6xl mx-auto p-6'>
        ...
        <div className='mb-8'>
          ...
          <p className='text-slate-600'>Relasi mu</p>
        </div>

        {/* counts */}
        <div className='mb-8 flex flex-wrap gap-6'>
          {dataArray.map((item, index)=>(
            <div key={index} className='flex flex-col items-center justify-center gap-1 border h-20 w-40 border-gray-200 bg-white shadoow rounded-md'>
                    ...
                    <div className='flex max-sm:flex-col gap-2 mt-4'>
                      ...
                      }
                      {
                        currentTab === 'Following' && (
                          <button className='w-full p-2 text-sm rounded bg-slate-100 hover:bg-slate-200 text-blaxk active:scale95 transition cursor-pointer'>
                            Unfollow
                          </button>
                        )
                      }
